...
export const CarritoVacio = ({id}) => {
  
  return (
    <>
    {id && <h2 className='text-center mt-5 text-lg  text-green-800' ><span className='p-2 bg-green-200 border border-green-500 rounded-lg'><span className='text-bold'>¡Gracias!</span> El id de tu compra es: {id}</span></h2>}
